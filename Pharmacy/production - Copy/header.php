            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a  href= "Purchase.php"><i class="fa fa-handshake-o"></i> Purchase </a>

                    <li><a  href= "Sales.php"><i class="fa fa-money"></i> Sales </a>

                     <li><a  href= "customer.php"><i class="fa  fa-odnoklassniki"></i> customer </a>

                      <li><a  href= "supplier.php"><i class="fa fa-list-alt"></i> supplier</a>

                       <li><a  href= "Bill.php"><i class="fa  fa-print"></i> Bill Recept</a>
                  ...
                  <li><a  href= "Diagnosis.php"><i class="fa fa-stethoscope"></i> Diagnosis </a>
                   ...
                   <li><a href= "drugs.php" ><i class="fa fa-medkit"></i> Drugs </a>
                   ...
                   <li><a href= "pharmacists.php"><i class="fa fa-user-md"></i> Pharmacists </a>
                    ...
                    <li><a href="about.php"><i class="fa fa-hospital-o"></i> About us </a>
