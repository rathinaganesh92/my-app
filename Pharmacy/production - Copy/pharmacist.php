            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a  href="stock.php"><i class="fa fa-cart-plus"></i> Stock Entry </a>

                  <li><a  href= "order.php"><i class="fa fa-heart"></i> Order Providers </a>
                  
                   <li><a href= "drugs.php" ><i class="fa fa-medkit"></i> Drugs </a>

                   <li><a href= "pharmacists.php"><i class="fa fa-user-md"></i> Pharmacists </a>

                    <li><a><i class="fa fa-wheelchair"></i> Patients </a>

                    <li><a><i class="fa fa-users"></i> Register Patient </a>

                    <li><a><i class="fa fa-hospital-o"></i> About us </a>
